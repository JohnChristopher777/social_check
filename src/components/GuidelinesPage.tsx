...
export default function GuidelinesPage({ onBack }: GuidelinesPageProps) {
  ...
  return (
    <div 
       ...
       className="w-full max-w-7xl mx-auto px-4 md:px-12 py-6 text-slate-300 pointer-events-auto h-[calc(100vh-100px)] overflow-y-auto scroll-smooth custom-scrollbar relative z-10"
    >
      {/* Main Content Layout */}
      <div className="py-6 flex flex-col lg:flex-row gap-12 lg:gap-16">
